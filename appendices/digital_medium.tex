...
\todo{actual file names, make the big pretty file structure}
-backup file without students
-generico filter template backup \todo{when they are cleaned up}
-configurable reports backup \todo{when they are cleaned up, wait until you have the reports finished}
-analysis jupyter files + pdf exports
-
