...
It is an introductory project to determine whether it is viable to teach modeling with the use of e-learning. We want this study to be a starting point for further educational content at \ac{fiit} should this project prove successful. In such a case, other researchers could extend the course by additional features and content and, most importantly, other types of diagrams.
