...
-We performed research\\
-found some practices that seem cool - name them\\
\textbf{Which of these e-learning practices are applicable to a software modeling course?}\\
-based on what other researchers used and our own schemes\\
-we find the following the most plausible\\
-repeat the list of things from previous chapters\\
...
-other researchers got positive responses\\

\section{Workflows}

\textbf{Class diagram of the system}

-diagram describes the entities in the system...\\
-users\\
-course and content\\
-tracking of students' progress\\
-extra stuff (gamification modules and what else could be there, recommendation - adaptive learning)
...
-shows the workflow from student's perspective\\
-just say in words what happens\\
...
-desribes the entire workflow of every entity in the system\\
-creation of content -> completing the course -> reviewing the results\\
