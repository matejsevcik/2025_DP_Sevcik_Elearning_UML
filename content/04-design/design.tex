...
The sequence diagram describes the interaction between all the major entities in the system - teacher, system, student. The teacher needs to authenticate themselves and create a course along with its contents. Then the student can enroll in the course and complete it in the flow already described in the activity diagram (see figure~\ref{fig:student_activity_diagram}). Lastly, the teacher can review the student's results and make their conclusions.
