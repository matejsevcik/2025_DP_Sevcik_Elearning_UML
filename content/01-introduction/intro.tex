...
Traditional classes often do not provide enough time and space for an actual teacher to give the necessary amount of attention to each of the students. This is related to late and insufficient feedback on modeling exercises. The answer to these problems might lie in electronic learning, or e-learning. It is a practice in which learning material is delivered through digital technologies.
...
Our course will implement a number of modern e-learning approaches to improve information retention, engagement, and the overall learning experience of the students. It will be tested on a sample of students at \ac{fiit}. The results will then be analyzed and studied approaches compared to determine the effectiveness and further potential of such tools in the process of education of software modeling. 
