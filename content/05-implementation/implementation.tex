...
Moodle allows us to implement the majority of the exercise types described in the design chapter \todo{ref to design}. \todo{talk about the missing drawing tool, rather mention its absence in a way that allows me to write a new section about it without rewriting this} The biggest issue is that Moodle does not support a diagram drawing tool by itself. This will be discussed in later sections of this work. Another, more prominent problem is automatically grading the diagrams.
...
\todo{feedback questionnaire report statistical}
