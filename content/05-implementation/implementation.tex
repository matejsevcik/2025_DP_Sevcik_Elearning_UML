...
We placed the chapter with explanations of concepts of the class diagram at the start of the courses. It is implemented as a number of Moodle's book resource\footnote{Moodle, "Book resource", \url{https://docs.moodle.org/501/en/Book_resource}, accessed December 13, 2025.} instances.
...
\subsection{Testing students' knowledge, feedback} \label{testing}
...
In the final assessment and introductory assessment sections, the immediate feedback is not present.  
...
Moodle provides statistics regarding individual quizes, exercises and the overall success of individual students\footnote{Moodle, "Statistics", \url{https://docs.moodle.org/501/en/Statistics}, accessed December 13, 2025.}. Reports can be downloaded in multiple formats including .csv. Statistics can be general, showing only the basics such as overall scores, or more nuanced and advanced statistics like effective weight or
...
Moodle is a web application. As the web server we chose Nginx.
