...
Traditional education of \ac{uml} faces several challenges such as low amount of feedback, late feedback, or a lack of space for personal attention from teachers.
...
Adaptive and personalized e-learning practices could be explored to address the varying baseline skill levels observed in our experiment. Other course designs can be implemented and compared for future reference.
