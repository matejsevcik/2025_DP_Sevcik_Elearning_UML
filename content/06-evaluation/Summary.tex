...
\textbf{Answer to RQ1:} Participants in competitive course design achieved consistently higher scores across exercises, categories and assessments. However, participants in the playful design achieved higher improvement rates, which can be largely attributed to lower baseline performance and more room for improvement. Although results suggest a slight performance advantage in the competitive design, both approaches lead to comparable learning outcomes overall.

\textbf{RQ2:} How do playful and competitive course designs influence students’ behavioral engagement?

\textbf{Answer to RQ2:} The designs led to different behavioral patterns. Participants in the playful course interacted more with the theoretical content, while participants in the competitive course had more quiz interactions and attempts. This suggests a tendency towards more exploratory behavior in \ac{pv}, and a more goal-oriented attitude in \ac{cv}.
...
\textbf{Answer to RQ3:} Participants of the playful course expressed higher enthusiasm, satisfaction and engagement in nearly all metrics as well as textual responses.
...
Responses in the competitive design exhibited higher variability, indicating that competition may have a polarizing effect on the students' perceptions. Playful design had more consistent responses and proved to be more accessible in general. 
